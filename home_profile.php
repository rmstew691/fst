...
$notification_keys = [];
$query = "SELECT * FROM fst_users_notifications_key;";
...
<title>Profile (v<?= $version ?>) - Pierson Wireless</title>
...
<body>
	...
	<div id ='preferences' class ='tabcontent' style='display:none'>
		...
		<div class="wrapper wrapper_preferences">
			...
			<table class = "profileTable" id = 'notification_settings_table'>

				<tr>
					<th></th>
					<th colspan="2" class = 'fst-tooltip'><span class="fa fa-info-circle"></span>Standard Settings<p>Notifications for projects you are assigned to.</p></th>
					<th colspan="2" class = 'show_manager fst-tooltip'><span class="fa fa-info-circle"></span>Manager Settings<p>Notifications for projects you manage.</p></th>			
				</tr>
				<tr>
					<th>Type</th>
				...
				foreach($notification_keys as $n){
					...
					<tr>
						<td class = 'fst-tooltip'><span class="fa fa-info-circle"></span><?= $n['full']; ?> <p><?= $n['description']; ?></p></td>
