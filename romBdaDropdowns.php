...
<head>
    ...
    <title>ROM Tool - Select BDA Kit (v1.3.1) - Pierson Wireless</title>
...
<body>
    ...
    <div id='users' class='tabcontent'>
        ...
        <table id="partsTable">
            <div id="dropdownSection">
                <div class="dropdownContainer">
                    <label for="bda_kit-select">BDA Kit:</label>
                    <select id="bda_kit-select" class="custom-select">
                        <option value="-1">No Value Selected</option>
                ...
                <div class="dropdownContainer">
                    <label for="pMarkup">P-Markup:</label>
                ...
                <div class="dropdownContainer">
                    <label for="aMarkup">A-Markup:</label>
        ...
        <button class="romBdaSelectionButton" onclick="populateTable()">Reset Table</button>
        <!-- <button class="romBdaSelectionButton" onclick="updateTable()">Update</button> Verification -->
        ...
        <script src="romBdaDropdowns.js"></script>
