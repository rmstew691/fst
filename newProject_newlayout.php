...
?>
	...
	<div id = 'new_project' class = 'tabcontent'>
		...
		<form action='newProject_handler.php' method='POST'>
			...
			<div id = 'step1' class = 'standout_div'>
				...
				<p><strong style = 'padding-right: 47px'>Location Name </strong><input type='text' class = 'location standard_input' id='location_name'  onKeyUp="z.search_handler(this)" onChange="z.search_handler(this)"></p>
					...
					<tr>
						...
						<td><input type='text' id = 'newloc_city' class = 'required_newloc' style = 'width: 10em' > &nbsp; 
							<select type='text' id = 'newloc_state' style = 'width: 5em' class = 'custom-select required_newloc'>
								...
								?>
							</select> &nbsp; <input type='text' id = 'newloc_zip' style = 'width: 5em' class = 'required_newloc'></td>
					</tr>
					<tr>
						<th>POC Name</th>
			...
			<div id = 'step2' class = 'standout_div' style = 'display:none'>
				...
				<h1>Step 1B: Enter Project Information</h1>
					...
					<tr>
						<th colspan = '2'><h2>Location Info</h2></th>
					...
					<tr>
						<th colspan = '2'><h2>Customer Info</h2></th>
					</tr>	
					<tr>
						<th>*Customer</th>
						<td>
					...
					<tr>
						<th colspan = '2'><h2>Project Info</h2></th>
					</tr>	
					<tr>
					...
					<tr>
						...
						<td>
							<textarea id = 'project_prelim_sow' class = 'standard_textarea required new_project' maxlength = '250'></textarea>  <i>Limit 250 Characters</i>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th>COP Required</th>
						<td>
							<select id = 'project_copRequired' class = 'custom-select standard_select required_wo new_project'>
								<option></option>
								<option value = 'Initial COP'>Yes</option>
								<option value = 'No Services Requested'>No</option>
							</select>
						</td>
					</tr>
					<tr style = 'height: 2em'>
	...
	<div class = 'ui-widget' id = 'add-address' style = 'display:none' title = 'Please Update Location Information'> 
		<table class = 'loc_tables' align = "center" border = "0px" style = "line-height:20px;">
			...
			<tr>
				<th>*Industry</th>
				<td><select class = 'custom-select standard_select' id = 'add_industry' style = 'height: 25px'>
						<option></option>
	...
	<div class = 'ui-widget' id = 'new-customer' style = 'display:none' title = 'Add New Customer'> 
		<table class = 'loc_tables' align = "center" border = "0px" style = "line-height:20px;">
			...
			<tr>
				...
				<td><select class = 'custom-select new_customer_required' id = 'new_customer_type' style = 'height: 25px !important; width: 20.55em;'>
						<option></option>
			...
			<tr>
				...
				<td><input type='text' id = 'new_customer_city' class = '' style = 'width: 9.1em' > &nbsp; 
					<select type='text' id = 'new_customer_state' style = 'width: 4em' class = 'custom-select '>
						...
						?>
					</select> &nbsp; <input type='text' id = 'new_customer_zip' style = 'width: 5em' class = ''></td>
			</tr>
			<tr>
	...
	<script>
        ...
        function update_design_required(){
			...
			//if design but not estimate, then initial design only
				...
				u.eid("project_design_required").value = "Initial Design Only";
			}
			//if estimate but not design, then cost estimate only
			else if (estimate && !design){
				u.eid("project_design_required").value = "Cost Estimate Only";
			}
			//otherwise, both are true, set to both
			else{
				u.eid("project_design_required").value = "Initial Design & Cost Estimate";
			}
		}
